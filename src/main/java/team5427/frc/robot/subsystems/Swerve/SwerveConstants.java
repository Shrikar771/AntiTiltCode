...
public final class SwerveConstants {
  ...
  public static final double rollPos = 0; //to be callibrated
  public static final double yawPos = 0; //to be callibrated
  public static final double pitchPos = 0; //to be callibrated
